...
import com.lma.lightkeyboard.keyboard.latin.common.UnicodeSurrogate;
import com.lma.lightkeyboard.keyboard.latin.settings.SpacingAndPunctuations;
import com.lma.lightkeyboard.keyboard.latin.utils.CapsModeUtils;
import com.lma.lightkeyboard.keyboard.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.lma.lightkeyboard.keyboard.latin.common.Constants.UnicodeSurrogate
